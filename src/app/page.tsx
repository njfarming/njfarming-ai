    ...
    <div className="space-y-0">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <OfferCard
              ...
              desc="Comprehensive offline training courses"
            />
            <OfferCard
              icon="📚"
              title="Expert Books"
              desc="In-depth guides and handbooks"
            />
            <OfferCard
              icon="🧠"
              title="Expert Knowledge"
              desc="Years of experience & expertise"
            />
            <OfferCard
              icon="💊"
              title="Health Solutions"
              desc="Medicines & wellness products"
            />
          </div>
        </div>
      </section>
              ...
              >
                {video.image ? (
                  <div className="relative h-40 bg-gradient-to-br from-gray-700 to-gray-900">
                    <Image
                      src={video.image || "/images/farrowing.png"}
                      alt={video.title}
                      fill
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                />
                <SmallCard
                  href="/starting-out/breeding-gestation"
                  title="Breeding & Gestation"
                  icon="❤️"
                />
                <SmallCard
                  href="/starting-out/farrowing"
                  title="Farrowing"
                  icon="🐣"
                />
                <SmallCard
                  href="/starting-out/finishing-pigs"
                  title="Finishing Pigs"
                  icon="📈"
                />
                <SmallCard
                  href="/starting-out/equipment-supplies"
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                />
                <SmallCard
                  href="/pig-basics/pasture"
                  title="Raising on Pasture"
                  icon="🌱"
                />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <SmallCard
                  href="/pig-health/disease-prevention"
      ...
      <section className="py-16 bg-yellow-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12">
            Master pig farming with our expert-led training sessions
          </p>
          ...
          <div className="text-center">
            <Link
              href="/training/offline"
              className="bg-green-700 text-white px-8 py-3 rounded-lg font-bold hover:bg-green-800"
            >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-12">
            Comprehensive guides written by pig farming experts
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                NJ Farming is a leading platform dedicated to helping farmers
                succeed in small-scale pig farming. With years of industry
                experience and proven expertise, we provide comprehensive
                training, educational resources, and practical guidance.
              </p>
              <p className="text-gray-600 mb-4 leading-relaxed">
                Our mission is to empower farmers with knowledge and skills
                needed for profitable and sustainable pig farming operations.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial) => (
              <div
                key={testimonial.id}
                className="bg-gray-50 rounded-lg p-6 border-l-4 border-yellow-400 shadow-lg"
              >
      ...
      <section className="bg-gradient-to-r from-green-700 to-green-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Ready to Transform Your Pig Farming?
          </h2>
          <p className="text-xl mb-8">
            Join thousands of successful farmers who have benefited from our
            training and resources
          </p>
          <Link
            href="/contact"
            className="bg-yellow-400 text-green-800 px-8 py-3 rounded-lg font-bold hover:bg-yellow-300 transition inline-block"
          >
            Get Started Today
          </Link>
        </div>
